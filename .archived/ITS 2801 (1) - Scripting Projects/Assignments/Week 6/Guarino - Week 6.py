...
IMAGE_FOLDER = "Scripting Projects (ITS 2801)/Assignments/Week 6/Images/"
...
def move_mc(rect,keys,time):
    ...
    # Originally used elif, but that restricted movement to one axis at a time, separate if statements allow diagonal movement
    if keys[pygame.K_w]:
        rect.y -= speed
    if keys[pygame.K_a]:
        rect.x -= speed
